...
import static com.taobao.demo.ParamSupported.getParameter;
...
public class DebugLifeCycleModule implements Module, ModuleLifecycle{
    ...
    public void control(final Map<String, String> param, final PrintWriter writer){
        ...
        final String cnPattern = ParamSupported.getParameter(param, "class");
        final String mnPattern = ParamSupported.getParameter(param, "method");
